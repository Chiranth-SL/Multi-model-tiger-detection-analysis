...
app = FastAPI(title="VGG11 Tiger Detection Service")

CLASS_NAMES = {0: "no_tiger", 1: "tiger"}
WEIGHTS_PATH = "/weights/VGG11_tiger.pt"
LOCAL_WEIGHTS_PATH = os.path.join(os.path.dirname(__file__), "..", "weights", "VGG11_tiger.pt")
...
@app.get("/")
def read_root():
    return {"service": "VGG11 Tiger Detection", "status": "running"}


@app.get("/health")
def health_check():
    return {"status": "healthy", "model": "VGG11"}
