...
app = FastAPI(title="GoogLeNet Tiger Detection Service")

CLASS_NAMES = {0: "no_tiger", 1: "tiger"}
WEIGHTS_PATH = "/weights/GoogLeNet_tiger.pt"
LOCAL_WEIGHTS_PATH = os.path.join(os.path.dirname(__file__), "..", "weights", "GoogLeNet_tiger.pt")
...
@app.get("/")
def read_root():
    return {"service": "GoogLeNet Tiger Detection", "status": "running"}


@app.get("/health")
def health_check():
    return {"status": "healthy", "model": "GoogLeNet"}
